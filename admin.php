...
<html>
	<head>
		<title>Admin Shopedia | <?php echo $websitetitle ?></title>
		<meta charset="utf-8">
					...
					<div style="display: table-row; height: 100%;">
						<div class="adminmenubar">
							<div class="stickythingy">
								...
								<a href="<?php echo $baseurl ?>admin.php"><div class="adminleftbaritem"><lord-icon src="https://cdn.lordicon.com/gmzxduhd.json" trigger="loop" colors="primary:#c7c116,secondary:#e8e230" stroke="100" style="width:30px" ></lord-icon> <?php echo uilang("Home") ?></div></a>
								<a href="<?php echo $baseurl ?>admin.php?newpost"><div class="adminleftbaritem"><lord-icon src="https://cdn.lordicon.com/mecwbjnp.json" trigger="loop-on-hover" colors="primary:#16c79e,secondary:#66d7ee" stroke="60" style="width:30px" ></lord-icon> <?php echo uilang("Add Product") ?></div></a>
								<a href="<?php echo $baseurl ?>admin.php?pictures"><div class="adminleftbaritem"><lord-icon src="https://cdn.lordicon.com/fgkmrslx.json" trigger="loop-on-hover" colors="primary:#16c79e,secondary:#66d7ee" stroke="60" style="width:30px" ></lord-icon> <?php echo uilang("Pictures") ?></div></a>
								<a href="<?php echo $baseurl ?>admin.php?categories"><div class="adminleftbaritem"><lord-icon src="https://cdn.lordicon.com/jvucoldz.json" trigger="loop-on-hover" colors="primary:#16c79e,secondary:#66d7ee" stroke="60" style="width:30px" ></lord-icon> <?php echo uilang("Categories") ?></div></a>
								<a href="<?php echo $baseurl ?>admin.php?orders"><div class="adminleftbaritem"><lord-icon src="https://cdn.lordicon.com/slkvcfos.json" trigger="loop-on-hover" colors="primary:#16c79e,secondary:#66d7ee" stroke="60" style="width:30px" ></lord-icon> <?php echo uilang("Orders") ?></div></a>
								<a href="<?php echo $baseurl ?>admin.php?settings"><div class="adminleftbaritem"><lord-icon src="https://cdn.lordicon.com/nobciafz.json" trigger="loop-on-hover" colors="primary:#16c79e,secondary:#66d7ee" stroke="60" style="width:30px" ></lord-icon> <?php echo uilang("Settings") ?></div></a>
								<a href="<?php echo $baseurl ?>admin.php?logout"><div class="adminleftbaritem"><lord-icon src="https://cdn.lordicon.com/huwchbks.json" trigger="loop-on-hover" colors="primary:#16c79e,secondary:#66d7ee" stroke="60" style="width:30px" ></lord-icon> <?php echo uilang("Logout") ?></div></a>
